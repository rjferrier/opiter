...
class DynamicDict(dict):
    ...
    allows values to be runtime-dependent upon the state of other values
    in the dict.  Each of these special values is specified as a
    function accepting a single dictionary argument.  The dictionary is
    used within the function body to look things up dynamically.
