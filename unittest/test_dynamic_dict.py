...
class TestDynamicDict(unittest.TestCase):
    ...
    def setUp(self):
        """I create a DynamicDict with two dynamic entries:
        'fahrenheit', which is lambda-based, and 'water_state', which is
        def-based (i.e. based on a conventionally defined function).
        Both rely on the 'celsius' entry, but I haven't defined this
        yet."""
    ...
    def test_missing_information_raises_error(self):
        """I try and obtain 'fahrenheit' before 'celsius' is defined.
    ...
    def test_nested_entry(self):
        """I add a 'human_response' entry which depends on
        'water_state'.  When 'celsius' is changed, 'human_response'
    ...
    def test_nested_object(self):
        ...
        try using it to create a new DynamicDict.  The new object should
        be equivalent, but not identical to, the old object.  That is,
        it should be a copy."""
        self.dynamic_dict['celsius'] = 0.
